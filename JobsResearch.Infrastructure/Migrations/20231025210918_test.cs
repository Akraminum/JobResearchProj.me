        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicantsNumber = table.Column<int>(type: "int", nullable: false),
                    RangeSalaryMin = table.Column<int>(type: "int", nullable: true),
                    RangeSalaryMax = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "JobSeekerUserSkill",
                columns: table => new
                {
                    JobSeekersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SkillsSkillId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobSeekerUserSkill", x => new { x.JobSeekersId, x.SkillsSkillId });
                    table.ForeignKey(
                        name: "FK_JobSeekerUserSkill_JobSeekers_JobSeekersId",
                        column: x => x.JobSeekersId,
                        principalTable: "JobSeekers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobSeekerUserSkill_Skills_SkillsSkillId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobSeekerUserSkill_SkillsSkillId",
                table: "JobSeekerUserSkill",
